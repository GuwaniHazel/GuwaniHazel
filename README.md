...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=26&pause=1000&color=8B5CF6&width=800&lines=Hey+there!+I'm+Guwani+Hathurusinghe+👋;Full-Stack+Developer+%7C+SLIIT+Undergraduate+🎓;Spring+Boot+%7C+MERN+Stack+%7C+Mobile+Developer+🚀;Always+Learning+%26+Building+💻)](https://git.io/typing-svg)
...
🌸 Information Technology Undergraduate | Full-Stack Developer | Mobile & Web Application Developer | Tech Enthusiast   
...
- 💡 Passionate Full-Stack Developer & Mobile Application Developer  

- 🌱 Currently exploring **Spring Boot, MERN Stack, Next.js, Android Development**   

- 🚀 Interested in scalable systems, cloud technologies,test automation  & clean architecture   

- 🎨 Love building real-world, user-focused software solutions  
...
`Python` `R` `Java` `JavaScript` `PHP` `SQL` `Kotlin` `C` `C++`



### 🌐 Web & Full-Stack Development

`MERN Stack` `MongoDB` `Express.js` `React.js` `Node.js` `Next.js` `Spring Boot` `REST APIs` 
...
`Node.js` `Express.js` `Spring Boot` `PHP` `Java Servlets`
...
`Git` `GitHub` `VS Code` `Postman` `Playwright` `Figma`



### 📚 Concepts

`OOP` `MVC Architecture` `REST APIs` `System Integration`
...
## 🌸 Flora Nest – Smart Flower & Plant Ordering Platform (2026)

- Built a full-stack e-commerce platform for flowers and plants  

- Implemented secure JWT authentication and role-based access control  

- Developed REST APIs using Spring Boot and tested with Postman  
...
<img height="180em" src="https://github-readme-stats.vercel.app/api?username=GuwaniHazel&show_icons=true&theme=tokyonight&hide_border=true" />



<img height="180em" src="https://github-readme-stats.vercel.app/api/top-langs/?username=GuwaniHazel&layout=compact&theme=tokyonight&hide_border=true" />



<p><img align="center" src="https://github-readme-streak-stats.herokuapp.com/?user=guwanihazel&" alt="guwanihazel" /></p>
...
[![Trophy](https://github-profile-trophy.vercel.app/?username=GuwaniHazel&theme=radical&no-frame=true&no-bg=true)](https://github.com/ryo-ma/github-profile-trophy)
...
<a href="https://github.com/GuwaniHazel">
...
<a href="https://www.linkedin.com/in/guwani-hathurusinghe-897929340/">
...
<a href="mailto:guwanihathurusinghe@gmail.com">
...
<a href="https://guwani-portfolio.lovable.app/">

<img src="https://img.shields.io/badge/Portfolio-8B5CF6?style=for-the-badge&logo=vercel"/>
